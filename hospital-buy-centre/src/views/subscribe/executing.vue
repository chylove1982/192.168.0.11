<template>
  <div class="app-container">
    ...
    >
      ...
      <form-com :formface="basicInfoBzface" :config="basicInfoBzConfig" :form="basicInfo.heard" />
      ...
      <!--<form-com :formface="basicInfoHfface" :config="basicInfoHfConfig" :form="basicInfo.heard" />-->

      <!--<div style="text-align: center">-->
      <!--<el-button type="primary" size="mini" v-="checkpass">确认回复</el-button>-->
...
export default {
  data() {
    return {
      ...
      config: { // 前端定义
        ...
        tableBtns: [{ name: '采购详情', type: 'add', apiurl: 'api/Spdrequisitionorder/GetRequisitionOrderMasterSaveByID' }]
      }, // 控制列表加载动画化
      listQuery: { // 查询条件
        pageSize: 10,
        pageIndex: 1,
  ...
  methods: {
    ...
    getList() {
      var dt = this.gettable('RequisitionOrderGetListYncgzx', this.listQuery)
    ...
    controlFun(e, r) {
      ...
      this.basicInfoMxface = this.gettableheaders('GetRequisitionOrderMasterSaveByIDMx')
      this.basicInfoBzface = this.gettableheaders('GetRequisitionOrderMasterSaveByIDBz')
