  ...
  <div class="app-container">
    <search-time>
      <span v-if="selectArr.length>0" slot="CRUD-btn" class="CRUD-btn">
        <el-button v-for="(item,index) in selectArr" :key="index" class="selectbtn" size="small" :type="item.type" @click="controlFun(index)">{{ item.name }}</el-button>
      </span>
    </search-time>
    ...
    >
      <!--分步器-->
      <steps :steps="steps" :curStep="curStep" :w="420"/>
      <div class="app-container">
        ...
        <!--基本信息-->
        <h3 class="title_line">请领情况</h3>
        <form-com :formface="basicInfoface" :config="basicInfoConfig" :form="basicInfo" />
        <!--生成经营许可-->
        <h3 class="title_line">领用产品明细</h3>
        <super-table :table="pendingOrderList" :tableface="tableface" :config="config" @controlFun="controlFun" />
        <!--审核意见-->
        <template>
          <h3 class="title_line">审核意见</h3>
          <form-com :formface="auditOpinionface" :config="auditOpinionConfig" :form="auditOpinion" />
          <div style="text-align: center">
            <el-button type="primary" size="mini">审核通过</el-button>
            <el-button type="warning" size="mini">驳回/补充资料</el-button>
            <el-button type="danger" size="mini">审核不通过</el-button>
          </div>
        </template>
  </div>
    </el-dialog>
...
export default {
  data() {
    return {
      ...
      curStep: 1, // 后端字段，当前所在
      steps: [ // 前端定义
        { curUrl: require('@/icons/image/process/shopping_cart_red.png'), noCurUrl: require('@/icons/image/process/shopping_cart.png'), stepDot: 0, stepName: '开单' },
        { curUrl: require('@/icons/image/process/order_red.png'), noCurUrl: require('@/icons/image/process/order.png'), stepDot: 1, stepName: '审核' },
        { curUrl: require('@/icons/image/process/deliver_goods_red.png'), noCurUrl: require('@/icons/image/process/deliver_goods.png'), stepDot: 2, stepName: '领用' },
        { curUrl: require('@/icons/image/process/transportation_red.png'), noCurUrl: require('@/icons/image/process/transportation.png'), stepDot: 3, stepName: '完成' }
      ],
      pendingOrderList: [ // 待处理订单列表 后端传
        { id: '1', orderID: '201905020023152666', name: '抗酸染色体、白蛋白、乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂', totalPrice: '120000000', requiredTime: '2019-9-7', consignee: '中心院材料库', state: '待审核', orderTime: '2019-9-7 19:30', linkman: '10' },
        { id: '2', orderID: '201905020023152667', name: '抗酸染色体、白蛋白、乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂', totalPrice: '120000000', requiredTime: '2019-9-7', consignee: '中心院材料库', state: '待审核', orderTime: '2019-9-7 19:30', linkman: '10' },
        { id: '3', orderID: '201905020023152668', name: '抗酸染色体、白蛋白、乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂', totalPrice: '120000000', requiredTime: '2019-9-7', consignee: '中心院材料库', state: '审核', orderTime: '2019-9-7 19:30', linkman: '10' },
        { id: '4', orderID: '201905020023152669', name: '抗酸染色体、白蛋白、乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂', totalPrice: '120000000', requiredTime: '2019-9-7', consignee: '中心院材料库', state: '待审核', orderTime: '2019-9-7 19:30', linkman: '10' },
        { id: '5', orderID: '2019050200231526610', name: '抗酸染色体、白蛋白、乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂', totalPrice: '120000000', requiredTime: '2019-9-7', consignee: '中心院材料库', state: '待审核', orderTime: '2019-9-7 19:30', linkman: '10' },
        { id: '6', orderID: '201905020023152611', name: '抗酸染色体、白蛋白、乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂', totalPrice: '120000000', requiredTime: '2019-9-7', consignee: '中心院材料库', state: '待审核', orderTime: '2019-9-7 19:30', linkman: '10' },
        { id: '7', orderID: '201905020023152612', name: '抗酸染色体、白蛋白、乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂', totalPrice: '120000000', requiredTime: '2019-9-7', consignee: '中心院材料库', state: '待审核', orderTime: '2019-9-7 19:30', linkman: '10' },
        { id: '8', orderID: '201905020023152613', name: '抗酸染色体、白蛋白、乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂', totalPrice: '120000000', requiredTime: '2019-9-7', consignee: '中心院材料库', state: '待审核', orderTime: '2019-9-7 19:30', linkman: '10' },
        { id: '9', orderID: '201905020023152614', name: '抗酸染色体、白蛋白、乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂', totalPrice: '120000000', requiredTime: '2019-9-7', consignee: '中心院材料库', state: '待审核', orderTime: '2019-9-7 19:30', linkman: '10' },
        { id: '10', orderID: '201905020023152615', name: '抗酸染色体、白蛋白、乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂乙肝pcr试剂', totalPrice: '120000000', requiredTime: '2019-9-7', consignee: '中心院材料库', state: '待审核', orderTime: '2019-9-7 19:30', linkman: '10' }
      ],
